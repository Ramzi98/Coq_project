...
Proof.
  intros l1 l2 l3 l4. induction l1 as [|n l' IHl'].
-
...
Fixpoint eqblist (l1 l2 : natlist) : bool :=
  ...
  | h1 :: t1 => match l2 with 
                | nil => false
                | h2 :: t2 => if(beq_nat h1 h2) then eqblist t1 t2 else false end
end.
