...
(* Sur quoi Injuction tactic est basée ?
  elle est basée sur le constructeur d'un type inductive et que ces constructeur sont Injective 
  (par exemple constructeur S pour les nat ou constructeur Cons[] poiur les lists) 
  elle cherche l'egalité entre les terms telle que à chaque fois il dérive le maximum 
  jusqu'a l'arrivé a un term *)
